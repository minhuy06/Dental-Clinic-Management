...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/css/cskh.css">
</head>
<body>
    <!-- ==================== HEADER ==================== -->
    <div class="header">
    ...
    <script src="${pageContext.request.contextPath}/js/cskh.js"></script>
</body>
</html>