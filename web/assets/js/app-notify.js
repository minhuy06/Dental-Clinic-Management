...
(function(global) {
    ...
    function success(message, title) {
        ...
        return openAlert({ type: 'success', title: title || 'Thành công', message: message });
    ...
    function error(message, title) {
        ...
        return openAlert({ type: 'error', title: title || 'Lỗi', message: message });
    ...
    function warn(message, title) {
        ...
        return openAlert({ type: 'warning', title: title || 'Cảnh báo', message: message });
    ...
    function doLogoutWithConfirm() {
        ...
        return openConfirm({ message: 'Bạn có chắc muốn đăng xuất?' }).then(function(ok) {
