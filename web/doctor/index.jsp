...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/assets/css/doctor-danhsach.css?v=20260518c">
...
<body>
    ...
    <script src="${pageContext.request.contextPath}/assets/js/doctor-danhsach.js?v=20260518c"></script>
</body>
</html>