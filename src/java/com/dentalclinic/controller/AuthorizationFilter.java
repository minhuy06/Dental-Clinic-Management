...
public class AuthorizationFilter implements Filter{
    ...
    public void doFilter(ServletRequest req,ServletResponse res,FilterChain chain) throws IOException,ServletException {
        ...
        TaiKhoan account = (session != null) ? (TaiKhoan) session.getAttribute("loggedInUser") : null;
        ...
        if(path.startsWith("/patient/") || path.equals("/home")|| path.equals("/index.jsp") || path.equals("/dat-lich.jsp")){
